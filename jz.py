...
# ── 路径 ──
LOG_FILE   = "/sdcard/Download/WechatReader/messages.log"
ALIPAY_DB  = "/data/data/com.eg.android.AlipayGphone/databases/messagebox.db"
ALIPAY_TMP = "/data/local/tmp/alipay_export.db"
LAST_ID    = "/sdcard/Download/WechatReader/.alipay_last_id"
CSV_FILE   = "/sdcard/Download/qianji.csv"       # ★ 单文件
